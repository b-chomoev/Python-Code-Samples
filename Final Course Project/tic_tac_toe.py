...
class TicTacToe:
    def __init__(self):
        self.board = [' ' for i in range(9)] # we will use a simple list to rep 3x3 board
    ...
    def make_move(self, square, letter):
        # if valid move, than make the move (assign square to letter)
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():
        ...
        if square is not None:  # Check if the move is not None
